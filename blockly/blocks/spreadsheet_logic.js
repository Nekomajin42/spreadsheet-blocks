...
Blockly.Blocks["spreadsheet_if"] =
{
	init: function()
	{
		...
		this.setColour(spreadsheetBlocks.colors.bluegrey.c1);
	}
};
...
Blockly.Blocks["spreadsheet_and/or"] =
{
	init: function()
	{
		...
		this.setTooltip(locale.help);
		this.setColour(spreadsheetBlocks.colors.bluegrey.c2);
	}
};
...
Blockly.Blocks["spreadsheet_not"] =
{
	init: function()
	{
		...
		this.appendValueInput("EXPRESSION");
		this.setTooltip(locale.help);
		this.setColour(spreadsheetBlocks.colors.bluegrey.c3);
	}
};