...
Blockly.Blocks["spreadsheet_index"] =
{
	init: function()
	{
		...
		this.setColour(spreadsheetBlocks.colors.teal.c1);
	}
};
...
Blockly.Blocks["spreadsheet_match"] =
{
	init: function()
	{
		...
		this.setTooltip(locale.help);
		this.setColour(spreadsheetBlocks.colors.teal.c2);
	}
};
...
Blockly.Blocks["spreadsheet_row/column"] =
{
	init: function()
	{
		...
		this.setTooltip(locale.help);
		this.setColour(spreadsheetBlocks.colors.teal.c3);
	}
};
...
Blockly.Blocks["spreadsheet_offset"] =
{
	init: function()
	{
		...
		this.setTooltip(locale.help);
		this.setColour(spreadsheetBlocks.colors.teal.c4);
	}
};
...
Blockly.Blocks["spreadsheet_indirect"] =
{
	init: function()
	{
		var locale = getBlockLocale("spreadsheet_indirect");
		this.setInputsInline(true);
		this.setOutput(true);
		this.appendDummyInput()
			.appendField(locale.name);
		...
		this.appendValueInput("TYPE");
		this.setTooltip(locale.help);
		this.setColour(spreadsheetBlocks.colors.teal.c5);
	}
};